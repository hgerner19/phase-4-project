        ...
        <div id="menuDiv">
            <div id="menuHeader" className="menuItemsDiv">
                ...
                <p className="menuDescription">
                    <h2>Below we have a large selection of delicious appetizers, meals, deserts, and drinks.</h2>
                    <h2>Whether you are just taking a look, getting ready to place a carryout order, or just want it delivered straight to your door this is the place to be!</h2>
                    <h2>If you would like to place an order, consider creating an account to earn points towards future orders!</h2>
                </p>
            </div>
